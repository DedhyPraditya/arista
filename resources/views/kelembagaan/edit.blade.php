                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_surat" id="tanggal_surat" class="form-control" value="{{ old('tanggal_surat', $kelembagaan->tanggal_surat ? \Carbon\Carbon::parse($kelembagaan->tanggal_surat)->format('Y-m-d') : '') }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @php
                                function renderKlasifikasiOptionsEditKelembagaan($nodes, $depth = 0, $selectedId = null) {
                                    foreach ($nodes as $node) {
                                        ...
                                        if ($node->isLeaf()) {
                                            ...
                                            renderKlasifikasiOptionsEditKelembagaan($node->children, $depth + 1, $selectedId);
                                            echo '</optgroup>';
                                        }
                                    }
                                }
                            ...
                            <select name="kode_klasifikasi_id" id="kode_klasifikasi_id" class="form-control" required>
                                ...
                                @isset($klasifikasiTree)
                                    @php(renderKlasifikasiOptionsEditKelembagaan($klasifikasiTree, 0, $kelembagaan->kode_klasifikasi_id))
                                @endisset
                            </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="lampiran" id="lampiran" class="form-control" value="{{ old('lampiran', $kelembagaan->lampiran) }}" >
                        </div>
