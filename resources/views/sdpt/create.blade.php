@extends('layouts.app')
@section('title', 'Tabel SDPT > Create')
@section('content')
<div class="container-fluid">
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah SDPT</h1>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Form Tambah SDPT</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('sdpt.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <!-- Submit Button -->
                        <a href="{{ route('sdpt.index') }}" class="btn btn-secondary" title="Kembali"><i class="fas fa-arrow-left"></i></a>
