                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal_surat" id="tanggal_surat" class="form-control" value="{{ old('tanggal_surat', $keuangan->tanggal_surat ? \Carbon\Carbon::parse($keuangan->tanggal_surat)->format('Y-m-d') : '') }}" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @php
                                    function renderKlasifikasiOptionsEditKeuangan($nodes, $depth = 0, $selectedId = null) {
                                        foreach ($nodes as $node) {
                                            ...
                                            if ($node->isLeaf()) {
                                                ...
                                                renderKlasifikasiOptionsEditKeuangan($node->children, $depth + 1, $selectedId);
                                                echo '</optgroup>';
                                            }
                                        }
                                    }
                                ...
                                <select name="kode_klasifikasi_id" id="kode_klasifikasi_id" class="form-control" required>
                                    ...
                                    @isset($klasifikasiTree)
                                        @php(renderKlasifikasiOptionsEditKeuangan($klasifikasiTree, 0, $keuangan->kode_klasifikasi_id))
                                    @endisset
                                </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="retensi_display" class="form-control" value="{{ old('retensi', $keuangan->retensi) }} th" readonly>
                                <input type="hidden" name="retensi" id="retensi" value="{{ old('retensi', $keuangan->retensi) }}">
                            </div>

                            <div class="form-group">
                                <label for="keterangan">Keterangan (Opsional)</label>
                                <textarea name="keterangan" id="keterangan" class="form-control" rows="2" placeholder="Catatan tambahan">{{ old('keterangan', $keuangan->keterangan) }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="lampiran" id="lampiran" class="form-control" value="{{ old('lampiran', $keuangan->lampiran) }}" >
                            </div>
